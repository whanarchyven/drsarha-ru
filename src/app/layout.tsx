...
export default function RootLayout({ children, ...rest }: RootLayoutProps) {
  ...
  return (
    <html lang="ru">
      <head>
        <title>Доктор Сара</title>
        <meta
          name="description"
          content="Первый российский новостной портал, где собраны все мировые новости по дерматологии и другим научным направлениям. Уникальная платформа с интегрированным персональным AI ассистентом помогает значительно ускорить процесс подготовки научных исследований и публикаций. Здесь вас ждут актуальные новости, статьи и материалы, специально созданные для профессионалов и исследователей в сфере дерматологии и смежных наук."
        />
        <RemResizeScript
          defaultFontSize={10}
